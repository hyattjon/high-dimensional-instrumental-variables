...
def UJIVE2(Y: NDArray[np.float64], X: NDArray[np.float64], Z: NDArray[np.float64], W: NDArray[np.float64] | None = None, *, talk: bool = False) -> UJIVE2Result:
    ...
    Notes:
        ...
        - Naming follows Stata's jive command (Poi 2006): UJIVE2 is the Angrist, Imbens, and Krueger (1999) JIVE2 in IV form (denominator 1 - 1/N); it equals Stata jive with ujive2 (verified: see validation/).
